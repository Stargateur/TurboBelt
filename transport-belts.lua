...
local factoriopedia_turbo_underground_belt =
{
  init =
  [[
...
local tungsten_belt_animation_set =
{
  ...
  animation_set =
  {
    filename = "__TurboBelt__/graphics/turbo-transport-belt/turbo-transport-belt.png",
    priority = "extra-high",
    size = 128,
    scale = 0.5,
    frame_count = 64,
  ...
  frozen_patch = {
    filename = "__TurboBelt__/graphics/turbo-transport-belt/turbo-transport-belt-frozen.png",
    priority = "extra-high",
    size = 128,
    scale = 0.5,
    line_length = 1,
...
data:extend
{
  ...
  },
  {
    ...
    factoriopedia_simulation = factoriopedia_turbo_underground_belt,
    max_distance = 11,
    ...
    structure =
    {
      direction_in =
      {
        sheet =
        {
          filename = "__TurboBelt__/graphics/turbo-underground-belt/turbo-underground-belt-structure.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          y = 192,
      ...
      back_patch =
      {
        sheet =
        {
          filename = "__TurboBelt__/graphics/turbo-underground-belt/turbo-underground-belt-structure-back-patch.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          scale = 0.5
      ...
      front_patch =
      {
        sheet =
        {
          filename = "__TurboBelt__/graphics/turbo-underground-belt/turbo-underground-belt-structure-front-patch.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          scale = 0.5
      ...
      frozen_patch_in =
      {
        sheet =
        {
          filename = "__TurboBelt__/graphics/frozen/underground-belt/underground-belt-structure.png",
          priority = "extra-high",
          width = 192,
          height = 192,
          y = 192,
  ...
  },
  {
    ...
    {
      north =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-north",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
      ...
      east =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-east",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
      ...
      south =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-south",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
      ...
      west =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-west",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
    ...
    structure_patch =
    {
      ...
      east =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-east-top_patch",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
      ...
      west =
          util.sprite_load("__TurboBelt__/graphics/turbo-splitter/turbo-splitter-west-top_patch",
            {
              frame_count = 32,
              priority = "extra-high",
              scale = 0.5
    ...
    frozen_patch =
    {
      north =
      {
        filename = "__TurboBelt__/graphics/frozen/splitter/splitter.png",
        priority = "extra-high",
        width = 192,
        height = 128,
        scale = 0.5
